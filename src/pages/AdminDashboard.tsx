          ...
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px overflow-x-auto scrollbar-hide" style={{scrollbarWidth: 'none', msOverflowStyle: 'none'}}>
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 sm:space-x-2 px-3 sm:px-6 py-3 sm:py-4 border-b-2 font-medium transition-colors text-xs sm:text-base whitespace-nowrap mr-4 ${
